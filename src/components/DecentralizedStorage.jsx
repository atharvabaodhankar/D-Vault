    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-purple-200 mb-8">Your Gateway to Decentralized Storage</p>
          
          {/* Stats */}
          <div className="flex justify-center space-x-8 mb-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-white">{files.length}</div>
              <div className="text-purple-200 text-sm">Files Stored</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white">∞</div>
              <div className="text-purple-200 text-sm">Storage Limit</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-white">🔗</div>
              <div className="text-purple-200 text-sm">IPFS Network</div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 mb-8 border border-white/20 shadow-2xl">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-3xl font-bold text-white">🔑 API Configuration</h2>
            <button
          ...
          {showInstructions && (
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 mb-6 border border-white/10">
              <h3 className="text-xl font-bold text-white mb-4">📋 How to Get Your Pinata API Keys</h3>
              <div className="space-y-4 text-purple-100">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">Go to <a href="https://app.pinata.cloud/" target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-purple-200 underline">app.pinata.cloud</a> and sign up for a free account</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">In your dashboard, click on "API Keys" in the sidebar</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">Click "Create New Key" and give it a name (e.g., "D-Vault")</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">You'll see both an <strong>API Key</strong> and a <strong>Secret Key</strong> - copy both!</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm opacity-80">Paste your keys in the fields below and click "Save API Keys"</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-purple-200 mb-3">
          ...
          <button
            onClick={saveApiKeys}
            className="mt-6 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-8 py-4 rounded-xl font-semibold hover:from-green-600 hover:to-emerald-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            💾 Save API Keys
          </button>
        </div>
        ...
        {/* File Upload Section */}
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 mb-8 border border-white/20 shadow-2xl">
          <h2 className="text-3xl font-bold text-white mb-6">📤 Upload Files to IPFS</h2>
          <div className="space-y-6">
            <div className="relative">
              <label className="block text-sm font-semibold text-purple-200 mb-3">
                📁 Select Your File
              </label>
              <div className="border-2 border-dashed border-purple-300/50 rounded-2xl p-8 text-center hover:border-purple-400 transition-all duration-300">
                <input
                  type="file"
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-purple-200 font-semibold">Click to select a file</p>
                  <p className="text-purple-300 text-sm">or drag and drop here</p>
                </div>
              </div>
            </div>
            
            {selectedFile && (
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 backdrop-blur-sm p-6 rounded-2xl border border-purple-300/30">
                <div className="flex items-center space-x-4">
                  <div className="text-4xl">📄</div>
                  <div>
                    <p className="text-white font-semibold">{selectedFile.name}</p>
                    <p className="text-purple-200 text-sm">{(selectedFile.size / 1024 / 1024).toFixed(2)} MB</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-3xl font-bold text-white">📂 Your Files on IPFS</h2>
            <button
              onClick={fetchFilesFromPinata}
              disabled={loading}
              className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 rounded-xl font-semibold hover:from-blue-600 hover:to-cyan-600 disabled:opacity-50 transition-all duration-300 transform hover:scale-105"
            >
          ...
          {!pinataApiKey || !pinataSecretKey ? (
            <div className="text-center py-12">
              ...
              <p className="text-purple-200 text-xl">Please save your API keys to view files</p>
            </div>
          ) : loading ? (
            <div className="text-center py-12">
              <div className="text-6xl mb-4 animate-spin">🔄</div>
              <p className="text-purple-200 text-xl">Loading files from IPFS...</p>
            </div>
          ) : files.length === 0 ? (
            <div className="text-center py-12">
              <div className="text-6xl mb-4">📭</div>
              <p className="text-purple-200 text-xl">No files found on IPFS</p>
              <p className="text-purple-300">Upload your first file to get started!</p>
            </div>
          ) : (
            <div className="grid gap-6">
              {files.map((file) => (
                <div key={file.id} className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-lg font-semibold hover:from-red-600 hover:to-pink-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 transform hover:scale-105"
                    >
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-4 py-2 rounded-lg font-semibold hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105"
                      >
                        📋 Copy Link
                      </button>
                    </div>
                    <div className="space-y-2">
                      ...
                      <a
                        ...
                        className="text-xs text-purple-300 hover:text-purple-200 break-all underline"
                      >
                        {file.upload.url}
                      </a>
                    </div>
